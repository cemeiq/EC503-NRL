...
This minimization is done through the SMaCoF (scaling by majorization fo complicated functions) algorithm \cite{de2011applications}. The algorithm is the following one:
