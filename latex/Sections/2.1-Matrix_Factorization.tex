...
Classical MDS only works for Euclidean spaces, so in the context of graphs, we use a slightly different version of MDS. This minimized the following objective function (stress):
\[
